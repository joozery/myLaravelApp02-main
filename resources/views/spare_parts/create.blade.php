...
<body>
    <div class="container mt-5">
        ...
        <div class="row card px-2 py-3 rounded-4 shadow-sm">
            <div class="col-12">
                <form action="{{ route('spare_parts.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-2">
                        <div class="col-12 d-flex justify-content-center mb-2">
                            <button type="submit" class="btn button-green w-100">เพิ่มข้อมูล</button>
                        </div>
                        <div class="col-12 d-flex justify-content-center mb-2">
                            <a href="{{ url('/home') }}" role="button" class="btn button-grey w-100">ย้อนกลับ</a>
                        </div>
                    </div>
                </form>
            </div>
